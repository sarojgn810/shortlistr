...
class LLMProvider:
    ...
    def complete(self, prompt: str, system: str = "", max_tokens: int = 1024,
        ...
        Args:
            ...
            json_mode:  Ask the provider to constrain output to valid JSON where
                        it can. Advisory — a provider that cannot is free to
                        ignore it, and callers must still parse defensively.
