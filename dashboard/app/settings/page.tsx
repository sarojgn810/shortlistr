  ...
  return (
    <DashboardShell title="Settings" breadcrumbs={["Home", "Settings"]}>
      <div className="w-full space-y-6">
        ...
        {/* App status */}
        <Section
          icon={online === false ? XCircle : CheckCircle2}
          title="App status"
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-mist/60 bg-white p-5">
            <div>
              <p className="text-base font-bold text-ink">
                {online === null ? "Checking…" : online ? "Running" : "Not connected"}
              </p>
              <p className="mt-1 text-sm leading-relaxed text-stone">
                {online === null
                  ? "Looking for Shortlistr on this computer…"
                  : online
          ...
          {scoring ? (
            <div className="max-w-2xl space-y-5">
              <HelpDetails title="What do these numbers mean?">
                <p>
                  <strong className="text-ink">Quick filter</strong> uses discovery fit
                  (0–100) against your target titles. Jobs below this number are not
                  auto-scored after a scan, so you aren’t flooded.
                </p>
                <p>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-sm text-stone">
                    Higher = fewer jobs scored. Matches your Profile min fit (try 40).
                  </span>
                </div>
              </div>
          ...
          <div className="max-w-2xl space-y-4">
            ...
            <HelpDetails title="Instantly / outreach CSV">
              <p>
                ...
                sequencer) yourself — Shortlistr never auto-sends email.
              </p>
            </HelpDetails>
          </div>
        </Section>
