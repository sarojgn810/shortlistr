...
export default function ProfilePage() {
  ...
  const startEdit = (section: string) => {
    ...
    setDraft({
      ...
      min_fit_score: profile.min_fit_score ?? 40,
        ...
        >
          {editing === "targeting" ? (
            <div className="space-y-4">
              ...
              <Field label={`Min fit score: ${draft.min_fit_score ?? 40}`}>
                <input type="range" min={0} max={100} step={5} value={Number(draft.min_fit_score ?? 40)}
            ...
            <ReadGrid>
              ...
              <Row
                label="Unlisted salary"
                value={
                  profile?.salary_unlisted === "skip"
                    ? "Skip roles without salary"
                    : profile?.salary_unlisted
                      ? "Include roles without salary"
                      : null
                }
              />
