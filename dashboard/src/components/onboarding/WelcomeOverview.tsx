...
const JOURNEY = [
  ...
  {
    icon: Brain,
    title: "Recommended: two free keys",
    body: "A Google Gemini key (aistudio.google.com/apikey) turns on real scoring, cover letters and chat. A Google Custom Search key turns on interview research. Neither needs a card, both have daily limits that suit one job search. Skip and everything still runs on keyword scoring.",
  },
  {
    icon: Radar,
...
const CHECKLIST = [
  ...
  "Recommended: add a free Gemini key on Connections (real scoring)",
  "Recommended: add a free Google Custom Search key (interview research)",
  "Optional: add a free Apify token on Connections (more job boards)",
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card padding="lg" className="space-y-4">
          ...
          <div className="rounded-xl bg-sage/30 px-4 py-3 text-sm leading-relaxed text-stone">
            ...
            add a free Gemini key → scan → evaluate → approve → prep → you apply.
          </div>
