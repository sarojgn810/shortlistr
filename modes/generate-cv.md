# Mode: generate-cv — ATS-Optimized PDF Generation
...
15. Run: `python3 -m automation.cli pdf /tmp/cv-{candidate}-{company}.html output/cv-{candidate}-{company}-{YYYY-MM-DD}.pdf --format={letter|a4}`
