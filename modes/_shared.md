...
<!-- ============================================================
     ...
     that improve with each shortlistr release.
     ============================================================ -->
...
1b. **First evaluation of each session:** Run `make sync-check` (or `python3 -m automation.cli sync-check`). If warnings, notify user.
...
| Bash | `python3 -m automation.cli pdf` |
